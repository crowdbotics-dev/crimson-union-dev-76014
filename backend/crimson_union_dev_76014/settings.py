"""
Django settings for crimson_union_dev_76014 project.
...
ROOT_URLCONF = 'crimson_union_dev_76014.urls'
...
WSGI_APPLICATION = 'crimson_union_dev_76014.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_union_dev_76014 API",
    "DESCRIPTION": "API documentation for crimson_union_dev_76014 App",
    "VERSION": "v1",
}
